...
setwd("R:/LOOMHAB1-Q0555/MarquezLegorreta2021Datasets/fmr1_dataset/free-swimming_behavior/data_and_scripts")
...
### the 2nd (p=3.056486e-05), 3rd (p=0.03403846) and 16th (p=0.03969664) loom are sig. different. the 11th is marginal (p=0.05599378).
...
### the 2nd (p=0.0005916218) and 9th (p=0.0395049) loom are sig.
