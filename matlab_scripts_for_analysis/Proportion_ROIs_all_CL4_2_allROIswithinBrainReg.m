...
%%%% this script is to look at the proportion of ROIs per brain region but
%%%% taking into account also not loom responding ROIs. It will help see
%%%% how many ROIs are loom responsive with in each region. 
%%%% it is based in proportion_ROIs_all_CL4_2.m
...
%%% to look at the proportion per brain region to see if it works
%%% NOTE: i am basing the proportion  in
%%% the total number of ROIs in that brian region. 
% 
% counter=1;
% figure;
...
save('All_Prop_CL4_per_fish_brainRegAllROIs_2.mat','All_Prop_CL4_per_fish');
