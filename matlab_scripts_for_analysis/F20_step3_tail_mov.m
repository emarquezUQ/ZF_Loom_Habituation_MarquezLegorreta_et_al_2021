...
load('final_F20_step1.mat','ZS_f20','idx_Fish_f20','idx_Plane_f20','rawregressF20','idx_rsq_test_f20short','High_corr_Nb_f20','High_corr_Nb_f20_short');
...
%%%%first 3 looms. for f20 it would be from 180 onwards. This is because
...
save('Tail_mov_F20.mat','idx_rsq_Mov','rsquare_loom_allmov2','ModelResults_allmovPerFish','loomtimes','Fish_with_behav_f20','Movements','-v7.3');
