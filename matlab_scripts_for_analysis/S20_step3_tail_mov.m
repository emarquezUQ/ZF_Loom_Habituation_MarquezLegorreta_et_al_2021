...
load('final_S20_step1.mat','ZS_s20','idx_Fish_s20','idx_Plane_s20','rawregressS20','idx_rsq_test_s20short','High_corr_Nb_s20','High_corr_Nb_s20_short');
...
%%%%first 3 looms. for s20 it would be from 180 onwards. This is because
