...
%%%%% this script is to collect the CNMF results of s20 group but this time
...
%saveas(gcf,'50rawclusters_CN_s20','jpg');


% clear Calcium Fitness GoodCalcium
% 
 save('s20_postKmeans_CN.mat','-v7.3');
...
%saveas(gcf,'500rawclusters_CN_s20','jpg');
...
for i=1:10
    ...
    print(Fighandle,strcat('500rawclusters_CN_s20_',num2str(i)),'-dpng','-r0');
    close all;
end

 
 save('s20_postKmeans_CN_500CL.mat','-v7.3');
